  ...
  extends LinearLayoutCompat
{
  ...
  private boolean tryOnMeasure(int paramInt1, int paramInt2)
  {
    ...
    if (localObject1 != null)
    {
      ...
      k = i + localObject1.getMeasuredHeight();
      j = View.combineMeasuredStates(0, localObject1.getMeasuredState());
    }
    i = 0;
    int i2 = 0;
    int m = j;
    ...
    if (localObject3 != null)
    {
      ...
      i2 = localObject3.getMeasuredHeight() - i;
      n = k + i;
    ...
    for (j = 0;; j = View.MeasureSpec.makeMeasureSpec(Math.max(0, i3 - n), i7))
    {
      ...
      if (localObject2 != null)
      {
        ...
        if (i4 > 0)
        {
          localObject2.measure(paramInt1, View.MeasureSpec.makeMeasureSpec(i1 + i4, i7));
          i = n - i1 + localObject2.getMeasuredHeight();
          j = View.combineMeasuredStates(m, localObject2.getMeasuredState());
        }
      }
      m = 0;
