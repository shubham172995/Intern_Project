  ...
  extends WidgetContainer
{
  ...
  private int countMatchConstraintsChainedWidgets(LinearSystem paramLinearSystem, ConstraintWidget[] paramArrayOfConstraintWidget, ConstraintWidget paramConstraintWidget, int paramInt, boolean[] paramArrayOfBoolean)
  {
      ...
      for (paramInt = i;; paramInt = i)
      {
        ...
        if (localConstraintWidget.mRight.mTarget != null)
        {
          ...
          if ((localObject2 != null) && (localObject2 != localConstraintWidget)) {
            localObject2.mHorizontalNextWidget = localConstraintWidget;
          }
        ...
        do
        {
          do
          {
            ...
            if ((paramConstraintWidget.mLeft.mTarget == null) || (localObject4.mRight.mTarget == null)) {
              paramArrayOfBoolean[1] = true;
            }
            paramConstraintWidget.mHorizontalChainFixedPosition = bool2;
            localObject4.mHorizontalNextWidget = null;
    ...
    for (paramInt = j;; paramInt = i)
    {
      ...
      if (localConstraintWidget.mBottom.mTarget != null)
      {
        ...
        if ((localObject2 != null) && (localObject2 != localConstraintWidget)) {
          localObject2.mVerticalNextWidget = localConstraintWidget;
        }
        localObject2 = localConstraintWidget;
        localObject1 = localObject3;
        i = paramInt;
      ...
      do
      {
        do
        {
          ...
          if ((paramConstraintWidget.mTop.mTarget == null) || (localObject4.mBottom.mTarget == null)) {
            paramArrayOfBoolean[1] = true;
          }
          paramConstraintWidget.mVerticalChainFixedPosition = bool2;
          localObject4.mVerticalNextWidget = null;
          paramArrayOfConstraintWidget[0] = paramConstraintWidget;
          paramArrayOfConstraintWidget[2] = localObject3;
          paramArrayOfConstraintWidget[1] = localObject4;
          paramArrayOfConstraintWidget[3] = localObject5;
  ...
  public void findHorizontalWrapRecursive(ConstraintWidget paramConstraintWidget, boolean[] paramArrayOfBoolean)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          {
            m = i;
            if (!localObject1.isRoot())
            {
              if (paramConstraintWidget.mRight.mTarget.mType != ConstraintAnchor.Type.RIGHT) {
                break;
              }
              j = i + (localObject1.mDistToRight - localObject1.getOptimizerWrapWidth());
              if ((!localObject1.mRightHasCentered) && ((localObject1.mLeft.mTarget == null) || (localObject1.mRight.mTarget == null) || (localObject1.mHorizontalDimensionBehaviour == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT))) {
                break label829;
              }
              bool1 = true;
              ...
              {
                if (localObject1.mLeft.mTarget != null) {
                  break label835;
                }
                m = j + (j - localObject1.mDistToRight);
              }
            }
          }
          i = k;
        ...
        i = k;
        j = m;
      } while (localObject2.isRoot());
      if (paramConstraintWidget.mLeft.mTarget.getType() != ConstraintAnchor.Type.LEFT) {
        break label856;
      }
      n = k + (localObject2.mDistToLeft - localObject2.getOptimizerWrapWidth());
      if (!localObject2.mLeftHasCentered)
      {
        bool1 = bool2;
        if (localObject2.mLeft.mTarget != null)
        {
          bool1 = bool2;
          if (localObject2.mRight.mTarget != null)
          {
            bool1 = bool2;
            if (localObject2.mHorizontalDimensionBehaviour == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {}
          }
        }
      }
      else
    ...
    for (;;)
    {
      i = n + (n - localObject2.mDistToLeft);
      j = m;
      break;
      j = i;
      ...
      label835:
      m = j;
      if (localObject1.mLeft.mTarget.mOwner == paramConstraintWidget) {
        break label623;
      }
      break label611;
      label856:
      ...
      n = k + localObject2.mDistToLeft;
      break label689;
      i = n;
      j = m;
      if (localObject2.mRight.mTarget.mOwner == paramConstraintWidget) {
        break;
      }
    }
  }
  ...
  public void layout()
  {
    ...
    while (i6 != 0)
    {
      ...
      try
      {
        this.mSystem.reset();
        i7 = i6;
        i6 = addChildrenToSolver(this.mSystem, 2147483647);
        i7 = i6;
        if (i6 != 0)
        {
          i7 = i6;
